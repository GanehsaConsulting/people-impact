    ...
    <section className="margin spacing">
      <div className="">
        ...
        <div className="text-center mb-16">
          ...
          <div className="md:text-lg text-darkColor/80 dark:text-lightColor/80 max-w-3xl mx-auto leading-relaxed" >
            <p >At People Impact, we are here to assist you with all your HR consulting needs.</p>
            <p>Whether you have questions about our services, want to discuss a potential project,</p>
            <p>or need further information, feel free to reach out to us.</p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
          ...
          <div className="space-y-8">
            ...
            <div className="bg-white dark:bg-secondaryDark rounded-main md:p-6 p-4 border border-secondaryLight dark:border-secondaryDark" style={{ boxShadow: "var(--shadow-mainShadow)" }}>
              <h2 className="text-2xl font-bold text-darkColor dark:text-lightColor mb-6">Contact Information</h2>
                    ...
                    <div key={index} className="group">
                      ...
                      >
                        ...
                        <div className="flex-1 min-w-0">
                          <h3 className="font-semibold text-darkColor dark:text-lightColor mb-1">{item.label}</h3>
                          <p className="text-sm text-darkColor/70 dark:text-lightColor/70 whitespace-pre-line leading-relaxed">{item.value}</p>
                        </div>
          ...
          <div className="bg-white dark:bg-secondaryDark rounded-main p-4 md:p-8 border border-secondaryLight dark:border-secondaryDark" style={{ boxShadow: "var(--shadow-mainShadow)" }}>
            <div className="mb-8">
              <h2 className="text-2xl font-bold text-darkColor dark:text-lightColor mb-3">Send us a message!</h2>
              <p className="text-darkColor/70 dark:text-lightColor/70">Have a question or want to schedule a consultation? Fill out the form below, and one of our team members will get back to you as soon as possible.</p>
            </div>
            ...
            {isSubmitted ? (
              <div className="text-center py-12">
                ...
                <h3 className="text-xl font-semibold text-darkColor dark:text-lightColor mb-2">Message Sent Successfully!</h3>
                <p className="text-darkColor/70 dark:text-lightColor/70 mb-4">Thank you for reaching out. We'll get back to you within 24 hours.</p>
                <p className="text-sm text-darkColor/60 dark:text-lightColor/60">You should also receive a confirmation email shortly.</p>
              </div>
            ) : (
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="grid md:grid-cols-2 gap-4">
                  {/* Name */}
                  <div>
                    <label className="block text-sm font-medium text-darkColor dark:text-lightColor mb-2">Full Name *</label>
                  ...
                  {/* Email */}
                  <div>
                    <label className="block text-sm font-medium text-darkColor dark:text-lightColor mb-2">Email Address *</label>
                    <div className="relative">
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  {/* Company */}
                  <div>
                    <label className="block text-sm font-medium text-darkColor dark:text-lightColor mb-2">Company</label>
                    <div className="relative">
                  ...
                  {/* Phone */}
                  <div>
                    <label className="block text-sm font-medium text-darkColor dark:text-lightColor mb-2">Phone Number</label>
                    <div className="relative">
                      <FaWhatsapp className="absolute left-3 top-1/2 transform -translate-y-1/2 w-5 h-5 text-darkColor/40 dark:text-lightColor/40" />
                      <input
                        type="tel"
                        name="phone"
                ...
                {/* Subject */}
                <div>
                  <label className="block text-sm font-medium text-darkColor dark:text-lightColor mb-2">Subject *</label>
                  <select
                    name="subject"
                ...
                {/* Message */}
                <div>
                  <label className="block text-sm font-medium text-darkColor dark:text-lightColor mb-2">Message *</label>
                  <textarea
                    name="message"
