...
const DOCUMENTS = {
  terms: {
    ...
    images: ["/TC/tc1.webp", "/TC/tc2.webp", "/TC/tc3.webp", "/TC/tc4.webp", "/TC/tc5.webp"],
  },
  privacy: {
    title: "Privacy Policy",
    images: ["/PP/pp1.webp", "/PP/pp2.webp", "/PP/pp3.webp"],
  },
};
...
const ImageViewer = ({ document: documentData, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/50 backdrop-blur-lg flex items-center justify-center p-4">
      {/* Close button */}
      <button onClick={onClose} className="absolute top-4 right-4 z-10 p-2 rounded-full bg-white/20 hover:bg-white/30 text-white transition-all duration-300">
      ...
      <div className="absolute top-4 left-4 z-10 text-white">
        ...
        <p className="text-sm opacity-80">
          Page {currentPage + 1} of {documentData.images.length}
        </p>
      </div>
      ...
      {documentData.images.length > 1 && (
        <>
          <button
            ...
            className={`absolute left-4 top-1/2 -translate-y-1/2 z-100 p-3 rounded-full transition-all duration-300 ${currentPage === 0 ? "bg-gray-500/30 text-gray-400 cursor-not-allowed" : "bg-main-1/30 hover:bg-main-1/100 text-white"}`}
          >
          ...
          <button
            ...
            className={`absolute right-4 top-1/2 -translate-y-1/2 z-100 p-3 rounded-full transition-all duration-300 ${
              currentPage === documentData.images.length - 1 ? "bg-gray-500/30 text-gray-400 cursor-not-allowed" : "bg-main-1/30 hover:bg-main-1/100 text-white"
            }`}
          >
    ...
    <footer className="relative">
      ...
      <div className="relative h-48 overflow-hidden">
        <svg className="absolute bottom-0 w-full h-full" viewBox="0 0 1200 200" preserveAspectRatio="none">
          ...
          <path d="M0,100 C300,200 900,0 1200,100 L1200,200 L0,200 Z" fill="url(#waveToFooter)" />
          {/* Second decorative wave layer */}
          <path d="M0,130 C300,60 900,180 1200,130 L1200,200 L0,200 Z" fill="url(#waveToFooter)" fillOpacity="0.3" />
          {/* Solid footer background wave - seamlessly connects */}
          <path d="M0,150 C300,80 900,200 1200,150 L1200,200 L0,200 Z" className="fill-lightColor dark:fill-darkColor" />
        </svg>
      </div>

      {/* Main Footer Content - seamlessly connected */}
      <div className="bg-lightColor dark:bg-darkColor relative -mt-1">
        <div className="relative pb-7 px-4 sm:px-6 lg:px-0">
          <div className="margin">
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 lg:gap-16">
              ...
              <div className="space-y-4">
                <div className="space-y-1">
                  <Link href="/" className="inline-block group">
                    <Image width={150} height={150} src="/icon.png" alt="Ganapatih Logo" className="dark:brightness-125 -ml-10" />
                  ...
                  <div className="text-darkColor/70 dark:text-lightColor/70 text-base">
                    <p>Empowering people,</p>
                    <p>transforming organizations</p>
                    <p>through innovative HR solutions.</p>
                  </div>
                </div>
              ...
              <div className="space-y-2">
                ...
                <div>
                  ...
                  <a
                    ...
                    className="group flex items-start space-x-4 text-darkColor/70 dark:text-lightColor/70 hover:text-main-1 dark:hover:text-main-1 transition-all duration-300 px-4 py-3 rounded-2xl hover:bg-white/50 dark:hover:bg-white/5 backdrop-blur-sm"
                  >
                    <div className="bg-gradient-to-br from-main-1 to-sec-1 p-3 rounded-xl text-white group-hover:scale-110 transition-transform duration-300">
                  ...
                  <a
                    ...
                    className="group flex items-start space-x-4 text-darkColor/70 dark:text-lightColor/70 hover:text-main-1 dark:hover:text-main-1 transition-all duration-300 px-4 py-3 rounded-2xl hover:bg-white/50 dark:hover:bg-white/5 backdrop-blur-sm"
                  >
                    <div className="bg-gradient-to-br from-main-2 to-sec-1 p-3 rounded-xl text-white group-hover:scale-110 transition-transform duration-300">
              ...
              <div className="space-y-3">
                <h4 className="text-xl font-semibold text-darkColor dark:text-lightColor flex items-center gap-3">
                  <div className="w-8 h-0.5 bg-gradient-to-br from-main-1 to-main-3 rounded-full"></div>
                  Quick Links
                </h4>
                ...
                <div className="space-y-2 mt-2">
                  <h5 className="text-sm font-semibold text-darkColor dark:text-lightColor uppercase tracking-wider flex items-center gap-2">
                    <div className="w-6 h-0.5 bg-gradient-to-br from-main-1 to-main-3 rounded-full"></div>
                    Our Location
                  </h5>
            ...
            {/* Enhanced Bottom Section - Copyright & Links */}
            <div className="border-t border-white/20 dark:border-white/10 pt-6 mt-8">
              <div className="flex flex-col lg:flex-row justify-between items-center gap-6">
                {/* Copyright Section - Enhanced Responsiveness */}
                <div className="text-darkColor/60 dark:text-lightColor/60 text-center lg:text-left">
                  {/* Desktop version - single line */}
                  <p className="hidden lg:block text-sm">Copyright ©2025 People Impact Human Resources Consultant. All Rights Reserved.</p>

                  {/* Mobile/Tablet version - multi-line */}
                  <div className="lg:hidden text-sm space-y-0.5">
                    <p className="font-medium">Copyright ©2025 People Impact</p>
                    <p>Human Resources Consultant</p>
                    <p>All Rights Reserved</p>
                  </div>
                </div>

                {/* Legal Links - Enhanced Mobile Layout */}
                <div className="flex flex-col sm:flex-row items-center gap-4 sm:gap-8">
                  <button
                    onClick={() => openDocument("terms")}
                    className="text-darkColor/60 dark:text-lightColor/60 hover:text-main-1 dark:hover:text-main-1 transition-all duration-300 inline-flex items-center gap-2 group text-sm hover:bg-white/10 dark:hover:bg-white/5 px-3 py-2 rounded-lg backdrop-blur-sm"
                  >
                  ...
                  <div className="hidden sm:block w-px h-4 bg-white/20 dark:bg-white/10"></div>
      ...
      {/* Image Viewer Modal */}
      {showDocument && <ImageViewer document={showDocument} onClose={closeDocument} />}
    </footer>
  );
};
