            ...
            {documentData.images.length > 1 && (
                <>
                    ...
                    <button
                        ...
                        className={`absolute right-4 top-1/2 -translate-y-1/2 z-100 p-3 rounded-full transition-all duration-300 ${currentPage === documentData.images.length - 1 ? "bg-gray-500/30 text-gray-400 cursor-not-allowed" : "bg-main-1/30 hover:bg-main-1/100 text-white"
                            }`}
                    >
                        ...
                        <div className="border-t border-white/20 dark:border-white/10 pt-7 pb-0">
                            <div className="flex flex-col md:flex-row justify-between items-center space-y-6 md:space-y-0">
                                ...
                                <div className="flex space-x-8">
                                    <button onClick={() => openDocument("terms")} className="text-darkColor/60 dark:text-lightColor/60 hover:text-main-1 dark:hover:text-main-1 transition-all duration-300 inline-flex items-center gap-2 group">
                                        Terms & Conditions
                                        <FiExternalLink className="w-3 h-3 group-hover:translate-x-1 group-hover:-translate-y-1 transition-transform duration-300" />
                                    </button>
                                    <button onClick={() => openDocument("privacy")} className="text-darkColor/60 dark:text-lightColor/60 hover:text-main-1 dark:hover:text-main-1 transition-all duration-300 inline-flex items-center gap-2 group">
                                        Privacy Policy
                                        <FiExternalLink className="w-3 h-3 group-hover:translate-x-1 group-hover:-translate-y-1 transition-transform duration-300" />
                                    </button>
                                </div>
