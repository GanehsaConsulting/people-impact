...
export const JobBoard = () => {
    ...
    const [uploadMethod, setUploadMethod] = useState('direct'); // 'direct' or 'form'
            ...
            <div className="">
                ...
                <div className="grid lg:grid-cols-1 gap-12 items-center">
                    ...
                    <div className="space-y-8">
                        {/* Method Selection */}
                        <div className="bg-lightColor dark:bg-darkColor rounded-main p-6 ">
                            <h3 className="text-lg font-semibold text-darkColor dark:text-lightColor mb-4">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                ...
                                <button
                                    ...
                                    className={`p-4 rounded-secondary border-2 transition-all duration-200 text-left ${uploadMethod === 'direct'
                                        ? 'border-main-1 bg-white dark:bg-black'
                                        : 'border-secondaryLight dark:border-secondaryDark hover:border-main-1/50'
                                        }`}
                                >
                                    <div className="flex items-center gap-3 mb-2">
                                        <FiUpload className={`w-5 h-5 ${uploadMethod === 'direct' ? 'text-main-1' : 'text-main-3'}`} />
                                        <span className="font-medium text-darkColor dark:text-lightColor">Direct Upload</span>
                                    </div>
                                    <p className="text-sm text-darkColor/70 dark:text-lightColor/70">
                                        Upload your CV directly to our system
                                    </p>
                                </button>
                                ...
                                <button
                                    ...
                                    className={`p-4 rounded-secondary border-2 transition-all duration-200 text-left ${uploadMethod === 'form'
                                        ? 'border-main-3 bg-white dark:bg-black'
                                        : 'border-secondaryLight dark:border-secondaryDark hover:border-main-3/50'
                                        }`}
                                >
                                    <div className="flex items-center gap-3 mb-2">
                                        <FiExternalLink className={`w-5 h-5 ${uploadMethod === 'form' ? 'text-main-3' : 'text-main-1'}`} />
                                        <span className="font-medium text-darkColor dark:text-lightColor">Google Form</span>
                                    </div>
                                    <p className="text-sm text-darkColor/70 dark:text-lightColor/70">
                                        Fill out our comprehensive form
                                    </p>
                                </button>
                            </div>
                        </div>

                        {/* Upload Card - Direct Upload */}
                        {uploadMethod === 'direct' && (
