...
export const ReBanner = ({ title, subtitle, className = "", titleClassName = "", contentClassName = "", children, renderContent }) => {
  ...
  return (
    <main className={`min-h-[50vh] md:min-h-[50vh] mt-4 ${className}`}>
      <section className="relative w-full overflow-hidden">
        {/* BACKGROUND IMAGE + GRADIENT OVERLAY */}
        <div className="w-full min-h-[50vh] md:max-h-[50vh] relative">
          <img
            src="https://images.unsplash.com/photo-1542435503-956c469947f6?q=80&w=1674&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
            alt="hero"
