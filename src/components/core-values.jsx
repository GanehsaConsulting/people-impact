...
import { FiZap, FiUsers, FiTrendingUp, FiHeart, FiTarget, FiStar } from 'react-icons/fi';
            ...
            <div className="space-y-12 md:space-y-16">
                ...
                <div className="text-center space-y-4 md:space-y-6">
                    ...
                    <div className="max-w-3xl mx-auto space-y-3">
                        ...
                        <p className="text-darkColor/70 dark:text-lightColor/70 text-base leading-relaxed">
                            These values shape our culture, drive our decisions, and inspire us to create meaningful impact for every client we serve.
                        </p>
                    </div>
                </div>

                {/* Main Values Grid - Enhanced Design */}
                ...
                {/* Additional Values - Compact Design */}
                <div className="space-y-6">
                    <div className="text-center">
                        <h3 className="text-xl md:text-2xl font-semibold text-darkColor dark:text-lightColor mb-3">
                            What Drives Us Forward
                        </h3>
                        <p className="text-darkColor/70 dark:text-lightColor/70 max-w-2xl mx-auto text-sm md:text-base">
                ...
                {/* Values in Action - Call to Action */}
                <div className="text-center bg-gradient-to-r from-main-1/5 via-main-2/5 to-main-3/5 dark:from-main-1/10 dark:via-main-2/10 dark:to-main-3/10 rounded-main p-6 md:p-8 border border-gray-200/50 dark:border-gray-700/50">
                    ...
                    <div className="flex flex-col sm:flex-row gap-3 justify-center items-center">
                        <button className="inline-flex items-center space-x-2 bg-gradient-to-r from-main-1 to-main-2 text-white px-6 py-3 rounded-lg font-semibold hover:shadow-lg hover:scale-105 transition-all duration-300">
                            <span>Learn About Our Process</span>
                            <FiTrendingUp className="w-4 h-4" />
                        </button>
                        <button className="inline-flex items-center space-x-2 border-2 border-main-1 text-main-1 px-6 py-3 rounded-lg font-semibold hover:bg-main-1 hover:text-white transition-all duration-300">
