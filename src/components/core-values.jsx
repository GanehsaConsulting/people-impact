      ...
      <div className="space-y-12 md:space-y-16">
        ...
        <div className="space-y-6">
          <div className="text-center">
            ...
            <p className="text-darkColor/70 dark:text-lightColor/70 max-w-2xl mx-auto text-sm md:text-base">Additional principles that fuel our passion and commitment to your success.</p>
          </div>
