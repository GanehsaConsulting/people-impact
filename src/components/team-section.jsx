    ...
    return (
        <>
                    ...
                    <div className="text-left mb-16">
                        ...
                        <div className="mt-6 max-w-3xl">
                            <p className="text-lg text-darkColor/80 dark:text-lightColor/80 leading-relaxed mb-4">
                                ...
                                along with our diverse and highly skilled team of HR professionals.
                            </p>
                            <p className="text-darkColor/70 dark:text-lightColor/70 leading-relaxed">
                                Each member brings a wealth of experience, expertise, and dedication, ensuring that we deliver 
                                exceptional HR consulting services tailored to your unique organizational needs.
                            </p>
                        </div>
                    </div>
                            ...
                            <div
                                ...
                                style={{
                                    background: index === 0 
                                        ...
                                        : 'linear-gradient(135deg, rgba(255,255,255,0.95) 0%, rgba(16, 185, 129, 0.05) 100%)'
                                }}
                            >
                                {/* Decorative Element */}
                                <div className={`absolute top-0 left-0 w-32 h-32 blur-xl rounded-full opacity-10 -translate-x-16 -translate-y-16 transition-all duration-500 group-hover:scale-110 ${
                                    index === 0 ? 'bg-main-1' : 'bg-main-3'
                                }`}></div>
                                ...
                                <div className="relative z-10">
                                    ...
                                    <div className="flex items-start gap-6 mb-6">
                                        ...
                                        <div className="relative">
                                            <div className={`w-28 h-28 rounded-2xl overflow-hidden flex-shrink-0 ring-4 transition-all duration-300 group-hover:ring-8 ${
                                            ...
                                            {/* Experience Badge */}
                                            <div className={`absolute -bottom-2 -right-2 px-3 py-1 rounded-full text-xs font-semibold text-white shadow-lg ${
                                                index === 0 ? 'bg-main-1' : 'bg-main-3'
                                            }`}>
                                                {member.experience}
                                            </div>
                                        ...
                                        <div className="flex-1">
                                            <div className="mb-4">
                                                <h3 className="text-2xl font-bold text-darkColor dark:text-lightColor leading-tight mb-1 group-hover:text-main-2 dark:group-hover:text-main-1 transition-colors duration-300">
                                                    {member.name}
                                                </h3>
                                                <p className={`font-semibold text-lg mb-2 ${
                                                    index === 0 ? 'text-main-1' : 'text-main-3'
                                                }`}>
                                                    {member.position}
                                                </p>
                                                <p className="text-sm text-darkColor/60 dark:text-lightColor/60 font-medium">
                                                    {member.specialty}
                                                </p>
                                            </div>
                                    ...
                                    {/* Summary */}
                                    <div className="mb-6">
                                        <p className="text-darkColor/80 dark:text-lightColor/80 leading-relaxed text-sm">
                                            {member.summary}
                                        </p>
                                    </div>
                                    ...
                                    <div className="mb-6">
                                        <div className="flex flex-wrap gap-2">
                                            {member.expertise.slice(0, 2).map((skill, skillIndex) => (
                                                <span
                                                    ...
                                                    className={`px-3 py-1.5 rounded-full text-xs font-medium transition-all duration-300 group-hover:scale-105 ${
                                                        index === 0 
                                                            ? 'bg-main-1/10 text-main-1 group-hover:bg-main-1/20' 
                                                            : 'bg-main-3/10 text-main-3 group-hover:bg-main-3/20'
                                                    }`}
                                                >
                                                    {skill}
                                                </span>
                                            ...
                                            {member.expertise.length > 2 && (
                                                <span className="px-3 py-1.5 bg-secondaryGray/50 dark:bg-darkColor/50 rounded-full text-xs text-darkColor/60 dark:text-lightColor/60 font-medium">
                                    ...
                                    <div className="flex justify-end">
                                        <div className="opacity-70 group-hover:opacity-100 transition-all duration-300 transform group-hover:scale-105">
                                            <div className={`flex items-center gap-2 font-semibold text-sm group/btn px-4 py-2.5 rounded-xl transition-all duration-300 ${
                                                index === 0 
                                                    ? 'bg-main-1/10 text-main-1 hover:bg-main-1/20 hover:shadow-lg hover:shadow-main-1/25' 
                                                    : 'bg-main-3/10 text-main-3 hover:bg-main-3/20 hover:shadow-lg hover:shadow-main-3/25'
                                            }`}>
                                                View Full Profile
            ...
            {selectedMember && (
                ...
                >
                    <div
                        className="bg-white dark:bg-secondaryDark rounded-3xl max-w-5xl w-full max-h-[95vh] overflow-y-auto no-scrollbar shadow-2xl"
                    ...
                    >
                        ...
                        <div className="sticky top-0 bg-white/50 dark:bg-black/50 backdrop-blur-xl border-b border-secondaryLight/50 dark:border-darkColor/50 py-4 px-8 flex items-center justify-between rounded-t-3xl">
                            <div className='flex md:flex-row flex-col md:items-center gap-1 md:gap-2'>
                                ...
                                <p className="px-2 py-1 rounded-full bg-main-3/50 w-fit font-semibold text-sm">
                            ...
                            <div className="grid lg:grid-cols-3 gap-10">
                                ...
                                <div className="lg:col-span-1">
                                    ...
                                    <div className="space-y-4">
                                        <h4 className="text-lg font-semibold text-darkColor dark:text-lightColor mb-4">
                                            Get in Touch
                                        </h4>
                                        <a
                                ...
                                <div className="lg:col-span-2 space-y-8">
                                    ...
                                    <div className="bg-gradient-to-br from-gray-50/50 to-white dark:from-gray-800/50 dark:to-gray-900/50 rounded-2xl p-6">
                                        ...
                                        <p className="text-darkColor/80 dark:text-lightColor/80 leading-relaxed text-lg">
                                            {selectedMember.bio}
                                        </p>
                                    </div>
