// lib/servicesData.js – final, merged & icon-updated
import {
  FaClipboardCheck,
  FaChartLine,
  FaComments,
...
export const servicesData = {
  "talent-acquisition-recruitment": {
    ...
    description:
      "In the fast-paced business environment, acquiring the right talent is crucial for your organization's success. At People Impact, we specialize in providing comprehensive talent acquisition and recruitment services designed to meet your specific needs and drive business growth.",
  ...
  "performance-management": {
    ...
    description:
      "We understand that effective performance management is essential for the success of any organization. Our Performance Management services are designed to help you cultivate a high-performance culture that aligns individual contributions with your business objectives.",
  ...
  "employee-engagement-retention": {
    ...
    description:
      "We believe that engaged employees are the cornerstone of a successful organization. Our Employee Engagement & Retention services are designed to enhance workplace satisfaction, boost morale, and increase retention rates, contributing to a harmonious and productive work environment.",
    ...
    services: [
      {
        ...
        description:
          "We offer comprehensive employee satisfaction surveys to gather valuable insights into the workplace atmosphere and employee sentiments. Our team analyzes the results to identify strengths and areas for improvement, providing you with actionable recommendations that align with your organization's goals.",
  ...
  "compensation-benefits": {
    ...
    description:
      "We understand that a well-structured compensation and benefits program is critical to attracting and retaining top talent. Our Compensation & Benefits services are designed to ensure your organization remains competitive while fostering employee satisfaction and compliance with regulatory requirements.",
    ...
    services: [
      {
        ...
        description:
          "We conduct comprehensive salary benchmarking to analyze your organization's compensation relative to industry standards and competitors. Our data-driven approach helps you understand market trends and ensures your salary structures are both competitive and equitable.",
        icon: FaChartBar,
      },
      {
        title: "Creating Competitive Compensation Packages",
        description:
          "We specialize in designing tailored compensation packages that align with your organization's goals and values. Our team works with you to develop a balance of base salaries, bonuses, and incentives that motivate and reward employees, ensuring that your offerings attract high-caliber talent.",
        icon: FaDollarSign,
      },
      {
        title: "Benefits Administration and Optimization",
        description:
          "Effective benefits administration is essential for employee satisfaction. We assist you in managing and optimizing your benefits programs, including health insurance, retirement plans, and other perks. Our goal is to provide clear communication of benefits to employees, ensuring they understand and appreciate their total compensation.",
        icon: FaGift,
      },
      {
        title: "Ensuring Compliance with Labor Laws and Regulations",
        description:
          "Navigating the complexities of labor laws and regulations can be challenging. Our expertise ensures that your compensation and benefits programs comply with all relevant legislation, mitigating risks and protecting your organization from potential liabilities. We keep you updated on changes in regulations to ensure ongoing compliance.",
        icon: FaBalanceScale,
      },
    ],
  ...
  "payroll-services": {
    ...
    description:
      "We recognize that accurate and timely payroll processing is critical to your organization's success and employee satisfaction. Our Payroll Services are designed to simplify the payroll process, ensuring that your employees are paid accurately while maintaining compliance with all relevant regulations.",
    ...
    services: [
      {
        ...
        description:
          "Our team handles all aspects of payroll processing, from data entry to payment distribution. We ensure streamlined and error-free payroll management, allowing you to focus on your core business operations while we take care of your payroll needs.",
        icon: FaCogs,
      },
      {
        title: "Calculation of Wages, Deductions, and Bonuses",
        description:
          "We accurately calculate employee wages and apply the necessary deductions, including taxes, benefits, and other withholdings. Additionally, we manage bonus calculations, ensuring that all compensation elements are processed smoothly and in compliance with regulations.",
        icon: FaCalculator,
      },
      {
        title: "Compliance with Tax Regulations and Reporting",
        description:
          "Navigating tax laws can be complex. Our payroll experts ensure compliance with all local, state, and federal tax regulations. We take care of tax calculations, withholding, and reporting, minimizing your risk of penalties and ensuring that your payroll processes adhere to legal standards.",
        icon: FaReceipt,
      },
      {
        title: "Conducting Payroll Audits and Reconciliation",
        description:
          "We provide payroll auditing services to review and verify payroll records, ensuring accuracy and identifying any discrepancies. Our reconciliation process guarantees that your payroll aligns with accounting records, giving you confidence in your financial reporting.",
  ...
  "hr-policies-procedures": {
    ...
    description:
      "Effective HR policies and procedures are essential for fostering a positive workplace culture, ensuring compliance, and mitigating risks. At People Impact, we specialize in developing comprehensive HR policies and procedures that align with your organizational goals and legal requirements.",
    heroImage: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
    services: [
      {
        title: "Drafting and Updating Employee Regulations Manuals",
        description:
          "We help you create clear and concise employee regulations manuals tailored to your organization's specific needs. Our team ensures that all policies reflect current best practices and legal standards, covering critical topics such as conduct, workplace safety, and anti-discrimination.",
        icon: FaFileAlt,
      },
      {
        title: "Developing HR Policies and Standard Operating Procedures (SOPs)",
        description:
          "We assist in developing comprehensive HR policies and SOPs that provide guidance on key HR functions, from recruitment and onboarding to performance management and termination processes. Our policies are designed to promote consistency and fairness while supporting your organizational objectives.",
        icon: FaCogs,
      },
      {
        title: "Compliance Assessment and Regulatory Guidance",
        description:
          "Navigating the complex landscape of labor laws and regulations can be challenging. Our experts conduct thorough compliance assessments to ensure your HR policies adhere to all applicable laws and regulations. We provide guidance on industry standards to help you maintain compliance and avoid potential liabilities.",
        icon: FaGavel,
      },
      {
        title: "Managing Risk Related to HR Policies",
        description:
          "We work with you to identify and manage risks associated with HR policies and practices. Our proactive approach includes reviewing existing policies, recommending improvements, and implementing strategies to mitigate risks related to employee relations, compliance, and operational efficiency.",
  ...
  "organizational-development": {
    ...
    description:
      "We understand that effective organizational development is crucial for navigating change, enhancing culture, and achieving business goals. Our comprehensive Organizational Development services are designed to support your organization in adapting to evolving market demands while fostering a collaborative and innovative environment.",
    ...
    services: [
      {
        ...
        description:
          "Navigating change can be challenging for any organization. We offer strategic change management support to help you implement transitions smoothly and effectively. Our approach includes assessing the impact of change, developing communication plans, and providing training and resources to ensure employees embrace and adapt to new initiatives.",
        icon: FaExchangeAlt,
      },
      {
        title: "Conducting Culture Assessments and Enhancements",
        description:
          "A strong organizational culture is essential for employee engagement and performance. We conduct thorough culture assessments to understand your current workplace environment and identify areas for enhancement. Our team collaborates with you to develop initiatives that promote a positive culture, align with your values, and drive organizational effectiveness.",
        icon: FaEye,
      },
      {
        title: "Designing and Aligning Organizational Structures",
        description:
          "An effective organizational structure lays the foundation for achieving strategic objectives. We assist you in designing and aligning your organizational structure to ensure clarity in roles, responsibilities, and reporting lines. By optimizing structure, we help you enhance collaboration, communication, and operational efficiency.",
        icon: FaSitemap,
      },
      {
        title: "Implementing Team-Building Strategies and Workshops",
        description:
          "Strong teams are vital for organizational success. We design and facilitate engaging team-building workshops that strengthen relationships, improve communication, and foster collaboration among team members. Our strategies aim to develop high-performing teams that work seamlessly towards common goals.",
        icon: FaUsers,
      },
    ],
  ...
  "compliance-support": {
    ...
    description:
      "We understand that navigating the complex landscape of labor laws and regulations can be challenging for organizations of all sizes. Our Compliance Support services are designed to help you stay informed, mitigate risks, and ensure that your HR practices align with legal requirements.",
    heroImage: "https://images.unsplash.com/photo-1521737604893-d14cc237f11d?q=80&w=2084&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
    services: [
      {
  ...
  "hr-technology-implementation": {
    ...
    description:
      "In today's fast-paced business environment, leveraging the right technology is crucial for enhancing HR efficiency and effectiveness. At People Impact, we specialize in HR Technology Implementation services designed to help organizations choose, implement, and optimize HR software solutions that align with their strategic goals.",
    heroImage: "https://images.unsplash.com/photo-1460925895917-afdab827c52f?q=80&w=2015&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
    services: [
      {
  ...
  "diversity-equity-inclusion": {
    ...
    description:
      "We believe that a diverse, equitable, and inclusive workplace is essential for fostering innovation and driving organizational success. Our DEI services are designed to help organizations build a culture that values diversity, promotes equity, and ensures that every employee feels included and empowered to contribute their best.",
    heroImage: "https://images.unsplash.com/photo-1521737604893-d14cc237f11d?q=80&w=2084&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
    services: [
      {
        title: "Developing DEI Strategies",
        description:
          "We partner with you to develop comprehensive DEI strategies tailored to your organization's unique culture and goals. Our approach involves assessing your current DEI landscape, identifying areas for improvement, and creating actionable plans that drive meaningful change.",
        icon: FaRocket,
      },
      {
        title: "Providing Training on Unconscious Bias and Inclusivity",
        description:
          "Understanding unconscious bias is crucial for creating an inclusive workplace. We offer training programs that help employees recognize and address their biases, fostering a culture of inclusivity. Our training sessions empower your team with the knowledge and skills needed to contribute to an equitable environment.",
        icon: FaBrain,
      },
      {
        title: "Establishing DEI Metrics and Reporting",
        description:
          "Measuring progress is vital for the success of any DEI initiative. We assist you in establishing clear DEI metrics and reporting mechanisms, enabling you to track progress and assess the effectiveness of your DEI strategies. Our data-driven approach ensures that you can make informed decisions and adjustments to your initiatives.",
        icon: FaFlag,
      },
      {
        title: "Facilitating Diverse Hiring Practices",
        description:
          "Attracting a diverse workforce begins with inclusive hiring practices. We help you design and implement recruitment strategies that promote diversity at all levels. Our services include developing job postings that appeal to a broad audience, training hiring managers on inclusive interviewing techniques, and ensuring that your selection processes are fair and equitable.",
        icon: FaUserCheck,
      },
    ],
